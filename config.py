...
def configure(env):
    ...
    if env["platform"] == "android":
        ...
        if (build["vungle"]):
            ...
            env.android_add_dependency("compile 'com.github.vungle:vungle-android-sdk:6.3.24'")
            env.android_add_dependency("compile 'com.google.android.gms:play-services-basement:16.0.0'")
            env.android_add_dependency("compile 'com.google.android.gms:play-services-location:16.0.0'")
        if (build["mopub"]):
            ...
            env.android_add_dependency("compile('com.mopub:mopub-sdk:5.4.1@aar') { transitive = true }")
            env.android_add_dependency("compile('com.mopub.volley:mopub-volley:2.0.0@aar') { transitive = true }")
